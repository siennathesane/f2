# Generated from Kubernetes CustomResourceDefinition: contourconfigurations.projectcontour.io
# API Version: apiextensions.k8s.io/v1
# Type: Custom Resource (kubernetes_manifest)

resource "kubernetes_manifest" "customresourcedefinition_contourconfigurations_projectcontour_io" {
  manifest = {
