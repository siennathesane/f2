# Generated from Kubernetes CustomResourceDefinition: systemrestores.longhorn.io
# API Version: apiextensions.k8s.io/v1
# Type: Custom Resource (kubernetes_manifest)

resource "kubernetes_manifest" "customresourcedefinition_systemrestores_longhorn_io" {
  manifest = {
