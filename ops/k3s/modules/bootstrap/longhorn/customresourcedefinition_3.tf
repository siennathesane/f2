# Generated from Kubernetes CustomResourceDefinition: backupbackingimages.longhorn.io
# API Version: apiextensions.k8s.io/v1
# Type: Custom Resource (kubernetes_manifest)

resource "kubernetes_manifest" "customresourcedefinition_backupbackingimages_longhorn_io" {
  manifest = {
