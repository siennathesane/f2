# Generated from Kubernetes CustomResourceDefinition: sharemanagers.longhorn.io
# API Version: apiextensions.k8s.io/v1
# Type: Custom Resource (kubernetes_manifest)

resource "kubernetes_manifest" "customresourcedefinition_sharemanagers_longhorn_io" {
  manifest = {
