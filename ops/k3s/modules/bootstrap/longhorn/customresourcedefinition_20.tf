# Generated from Kubernetes CustomResourceDefinition: volumeattachments.longhorn.io
# API Version: apiextensions.k8s.io/v1
# Type: Custom Resource (kubernetes_manifest)

resource "kubernetes_manifest" "customresourcedefinition_volumeattachments_longhorn_io" {
  manifest = {
