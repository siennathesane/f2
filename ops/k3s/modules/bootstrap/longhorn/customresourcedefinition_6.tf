# Generated from Kubernetes CustomResourceDefinition: backupvolumes.longhorn.io
# API Version: apiextensions.k8s.io/v1
# Type: Custom Resource (kubernetes_manifest)

resource "kubernetes_manifest" "customresourcedefinition_backupvolumes_longhorn_io" {
  manifest = {
