# Generated from Kubernetes CustomResourceDefinition: supportbundles.longhorn.io
# API Version: apiextensions.k8s.io/v1
# Type: Custom Resource (kubernetes_manifest)

resource "kubernetes_manifest" "customresourcedefinition_supportbundles_longhorn_io" {
  manifest = {
