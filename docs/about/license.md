...
# Software License Agreement and Usage Policies

We believe in the importance of the concept "by the people, for the people." However, in modern times we recognize the need for extreme caution. Nominally, if we thought it was feasible, we would open source this as public domain. However, there is too great a risk of misuse and abuse of our technology. So this is our attempt at finding a balance between open source and responsible use.

f2 uses a Responsible AI License (RAIL) for our public source code. RAIL empowers us to restrict the use of our AI technology in order to prevent irresponsible and harmful applications. This license include behavioral-use clauses which grant permissions for specific use-cases and/or restrict certain use-cases. In case of derivative works, our RAIL License also requires that the use of any downstream derivatives (including use, modification, redistribution, repackaging) of the our licensed works must abide by the behavioral-use restrictions.

Below is a copy of our license agreement, which can also be found at the root of our source code repository.
