...
impl serde::Serialize for CreateUserRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("f2.users.v1.CreateUserRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for CreateUserRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct f2.users.v1.CreateUserRequest")
            }
        ...
        deserializer.deserialize_struct("f2.users.v1.CreateUserRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CreateUserResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("f2.users.v1.CreateUserResponse", len)?;
        if let Some(v) = self.user.as_ref() {
            struct_ser.serialize_field("user", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for CreateUserResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct f2.users.v1.CreateUserResponse")
            }
        ...
        deserializer.deserialize_struct("f2.users.v1.CreateUserResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for User {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("f2.users.v1.User", len)?;
        if !self.id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for User {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct f2.users.v1.User")
            }
        ...
        deserializer.deserialize_struct("f2.users.v1.User", FIELDS, GeneratedVisitor)
    }
}
